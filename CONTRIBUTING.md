...
Thanks for helping improve Claude Usage Micro. Bug reports, small fixes, tests, and focused feature ideas are welcome.
...
- Report security problems privately through [GitHub Security Advisories](https://github.com/scottdflorida/claude-usage-micro/security/advisories/new).
